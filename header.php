    ...
    <nav class="w-75 container-fluid navbar navbar-expand-lg navbar-light bg-light p-0 sticky-top">
        <div class="container-fluid" style="background-color: #e6e6fa;">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-link" href="search.php">Поиск станций велопроката</a>
                <a class="nav-link" href="allstations.php">Все станции велопроката Москвы</a>
                <a class="nav-link active" aria-current="page" href="registr.php">Вход/Регистрация</a>
            </div>
        </div>
    </nav>
